...
const rules: KarabinerRules[] = [
  ...
  ...createHyperSubLayers({
    ...
    w: {
      ...
      k: open("raycast://extensions/raycast/window-management/left-half"),
      j: open("raycast://extensions/raycast/window-management/right-half"),
